...
<div class="main_div">
 ...
 <img src = "2.jpg " class="center" width = 70% height = 70% style="margin-top:40px;">;
...
<div class="container three">
        ...
        <h2 class="text-center pt-4" style="color : red;"><marquee direction="right" behavior='scroll'>Transfer Money Here !<span>&#128071;</span></marquee></h2>
        ...
        <br>
            ...
            <br><br>
                ...
                <button class="btn btn-outline-dark mb-3" name="submit" type="submit" id="myBtn" >Transfer Now</button>
            </div>
        </form>
    </div> 
